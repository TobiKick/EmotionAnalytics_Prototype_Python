...
## Tasks:
• Implementation of a state-of-the-art Deep Learning solution based on current literature
• Comparison of various Deep Learning methods through Ablation Study.
• User experiment setup in order to verify the viability of Emotion Recognition to identify interest in a business context

## Outcome:
In this master thesis I could prove that my solution was able to outperform some state-of-the-art papers
...
• Pre-trained networks: MTCNN, VGGFace
